...
![Получить эксперимент](screens/experiments.png)
...
![Статистика JSON](screens/statistics_get.png)
...
![Статистика HTML](screens/statistics.png)
...
![Статистика HTML 2](screens/statistics_page.png)
...
DATABASE_URL=sqlite:///./abtesting.db uvicorn app.main:app --host 127.0.0.1 --port 8000
```
