...
def test_create_short_url(client):
    """Test creating short URL without custom code."""
...
def test_create_short_url_with_custom_code(client):
    """Test creating short URL with custom code."""
    response = client.post(
        "/api/v1/shorten",
...
def test_create_short_url_duplicate_custom_code(client):
    """Test creating short URL with duplicate custom code."""
    client.post(
        "/api/v1/shorten",
...
def test_create_short_url_invalid_custom_code(client):
    """Test creating short URL with invalid custom code."""
    response = client.post(
        "/api/v1/shorten",
